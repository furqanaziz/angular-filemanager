(function(angular, $) {
    ...
    angular.module('FileManagerApp').service('apiHandler', ['$http', '$q', '$window', '$translate', 'Upload',
        ...
        ApiHandler.prototype.list = function(apiUrl, path, customDeferredHandler, params, exts) {
            var self = this;
        ...
        ApiHandler.prototype.getUrl = function(apiUrl, path, isOriginal) {
            var data = {
                action: 'download',
                path: path,
        ...
        ApiHandler.prototype.download = function(apiUrl, itemPath, toFilename, downloadByAjax, forceNewWindow, isOriginal) {
            var self = this;
            var url = this.getUrl(apiUrl, itemPath, isOriginal);
